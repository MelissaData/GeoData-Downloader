# Melissa - Geo*Data Downloader

This is the script that downloads geographic data for you to use.

For the latest Geo*Data release notes, please visit: 
- https://releasenotes.melissa.com/reference-data/geo-data/


## Tested Environments
- Windows 64-bit .NET Runtimes 7.0, Powershell 5.1
- Ubuntu Linux 20.04.04 LTS 64-bit .NET 7.0
- Melissa Geo*Data for 2023-Q4
...
```
$ git clone https://github.com/MelissaData/GeoData-Downloader
$ cd GeoData-Downloader
```
...
You will need to set your license before running the `GeoData_Downloader.ps1`. 
...
You will need to set your license before running the `GeoData_Downloader.sh`. 
